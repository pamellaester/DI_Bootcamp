#create a matrix to be a base of the game
#gotta criate the out-lines inside the grid
#put matrix as a "def"
#criate def for :
# The first player to get 3 of their marks in a row (up, down, across, or diagonally
# 9 squares are full, the game is over (3 marks in a row, the game ends in a tie.)
